...
//loadPage시작---------------------------------------------------------------------------
            function loadPage(page) {
            	var url = 'https://api.themoviedb.org/3/movie/upcoming?language=ko-KR&page=' + page + '&region=kr&api_key=d266bc87db778e91facf58b4bcde4f31';
                ...
                $.ajax({
                    ...
                    success: function (res) {
                        ...
                        res.dates.minimum = currentDate;
                     	...
                     	// 영화 정보를  movie.release_date 기준으로 오름차순 정렬
